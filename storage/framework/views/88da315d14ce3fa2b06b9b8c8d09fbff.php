...
<div class="form-head d-flex mb-3 align-items-start">
    <div class="me-auto d-none d-lg-block">
        ...
        <p class="mb-0">Welcome to Sanetti Admin!</p>
    </div>
</div>
<div class="row">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body d-flex flex-column justify-items-center text-center justify-content-center">
                <h1 class="text-primary fw-bold">Wellcome To Sanetti Admin</h1>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sanettic/demo.sanetti.co.id/resources/views/admin/index.blade.php ENDPATH**/ ?>