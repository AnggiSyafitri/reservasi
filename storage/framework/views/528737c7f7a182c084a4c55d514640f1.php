...
<div class="row page-titles">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="javascript:void(0)">Sanetti / Admin / Profile</a></li>
    </ol>
</div>
<!-- row -->
<div class="row">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sanettic/demo.sanetti.co.id/resources/views/admin/profile.blade.php ENDPATH**/ ?>