...
<div class="container pt-4">
    <div data-aos="fade-up" data-aos-anchor-placement="top-bottom" class="text-center">
        ...
        <p class="text-justify" style="text-indent: 50px">Selamat datang di Rumah Sanetti! Kami adalah Retoran yang berkonsep keluarga dengan nuansa bangunan yang
            ...
            gurih hingga Spaghetti yang lezat, dari Shareloin yang juicy hingga Nasi Campur Legian yang autentik, kami
        ...
        <p class="text-justify" style="text-indent: 50px;">
            ...
            Rumah Sanetti buka mulai pukul 08:00 hingga 20:00, sehingga anda dapat menikmati hidangan kami sepanjang
...
<?php echo $__env->make('layouts.landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sanettic/demo.sanetti.co.id/resources/views/client/index.blade.php ENDPATH**/ ?>