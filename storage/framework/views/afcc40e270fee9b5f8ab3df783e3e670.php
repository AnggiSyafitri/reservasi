                    ...
                    <table id="datatables" class="display table table-striped" style="min-width: 845px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="p-3">
                                    <img src="<?php echo e('/uploads/menus/'.$menu->image); ?>" width="128" class="img-fluid rounded" alt="">
                                </td>
                                <td class=""><?php echo e($menu->type); ?></td>
                                <td class="">
                                    <div class="d-flex gap-2 justify-content-center">
                                        <a href="<?php echo e(route('menus.edit', $menu->id)); ?>" class="btn btn-secondary btn-sm"><i class="fa fa-edit"></i></a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sanettic/demo.sanetti.co.id/resources/views/menus/list.blade.php ENDPATH**/ ?>