    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('aditionalOffers.update', $data->id) }}" enctype="multipart/form-data" method="post">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <x-trix-field name="detail" id="detail" value="{!! $data->detail !!}" />
                        @error('detail')
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <div class="mt-3 p-3">
                            <img src="{{ '/uploads/aditionalOffers/'.$data->image }}" width="128" class="img-fluid rounded" alt="">
                        </div>
                    </div>
                    <div class="mb-3">
                        <button type="submit" class="btn btn-primary me-2">Add</button>
                        <a href="{{ route('aditionalOffers.index') }}" class="btn btn-secondary">Back</a>
                    </div>
                </form>
            </div>
        </div>
