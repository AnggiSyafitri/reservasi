    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('menus.update', $data->id) }}" enctype="multipart/form-data" method="post">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="type" value="{{ $data->type }}" class="form-control @error('type') is-invalid @enderror">
                        @error('type')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="price" value="{{ $data->price }}" class="form-control @error('price') is-invalid @enderror">
                        @error('price')
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <div class="mt-3 p-3">
                            <img src="{{ '/uploads/menus/'.$data->image }}" width="128" class="img-fluid rounded" alt="">
                        </div>
                    </div>
                    <div class="mb-3">
