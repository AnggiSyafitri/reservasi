...
<div class="row page-titles mx-0">
    ...
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <a href="{{ route('informations.create') }}" class="btn btn-primary">Add Information</a>
    </div>
</div>
<div class="row">
    <div class="col-12">
                    ...
                    <table id="datatables" class="display table table-striped" style="min-width: 845px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="p-3">
                                    <img src="{{ '/uploads/informations/'.$information->image }}" width="128" class="img-fluid rounded" alt="">
                                </td>
                                <td class="">
                                    <a target="_blank" class="text-underline" href="{{ '/uploads/informations/'.$information->file }}"><i class="fa fa-file-pdf"></i> {{ $information->file }}</a>
                                </td>
                                <td class="">
                                    <div class="d-flex gap-2 justify-content-center">
                                        <a href="{{ route('informations.edit', $information->id) }}" class="btn btn-secondary btn-sm"><i class="fa fa-edit"></i></a>
