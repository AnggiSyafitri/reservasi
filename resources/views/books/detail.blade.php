                    ...
                    <div class="col-lg-8 order-lg-1">
                        ...
                        <form method="POST" accept="{{ route('reservation.create') }}" id="form_step4" class="needs-validation" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mt-3 p-3">
                                    <img src="{{ '/uploads/proofs/'.$data->proof }}" width="128" class="img-fluid rounded" alt="">
                                </div>
                                <div class="p-3">
                                    <a href="{{ '/uploads/proofs/'.$data->proof }}" target="_blank">See detail</a>
                                </div>
                            </div>
                            {{-- input menus --}}
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('books.verify', $data->id) }}" class="btn btn-success gap-2"><i class="fa fa-check"></i> Verify</a>
                                <a href="{{ route('books.reject', $data->id) }}" class="btn btn-warning">
...
@section('script')
    <script>
        ...
        _input = data
        $("#total_price_step4").html(rupiah(caculateTax(18.5, parseInt("{{ $data->menus()->sum('total_price') }}"))))
